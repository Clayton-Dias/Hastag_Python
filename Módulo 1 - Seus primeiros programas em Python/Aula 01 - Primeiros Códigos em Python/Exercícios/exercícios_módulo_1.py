...
margem_lucro = lucro_loja / (faturamento_coca + faturamento_pepsi)

print(f"{margem_lucro:.2f}")
...
"""
codigo_produto = input("Digite o código do produto (insira os códigos com letra maiúscula): ")

print('Produto Alcoolico ?')
print("BAC" in codigo_produto)
