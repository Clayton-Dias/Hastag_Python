...
if venda <= meta:
    print('Não atingiu a meta, logo não ganhará bônus.')
elif venda > (meta*2):
    bonus = venda * 0.07
    print(f'Atingiu o dobro da meta, logo ganhará bônus de R$ {bonus:.2f}.')
else:
    bonus = venda * 0.03
    print(f'Atingiu a meta, logo ganhará bônus de R$ {bonus:.2f}.')
